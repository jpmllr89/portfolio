const data = {
  ...
  dataPortfolioCards: [
    ...
    {
      picture: "./assets/img/coderlandingpage.png",
  ...
  dataModals: [
    {
      ...
      strongParagraph: "Software as a Service Website",
      firstParagraph:
        "This is a website for a SaaS company. It is a responsive website that is built with HTML, CSS, and JavaScript. It is a single page website that has a smooth scroll effect",
    ...
    },
    {
      ...
      firstParagraph:
        "This is a recipe collection app that uses an API to fetch recipes. It is a single page, responsive website that is built with HTML, CSS, and JavaScript and has a smooth scrolling effect.",
    ...
    },
    {
      ...
      firstParagraph:
        "Law Firm Small business landing page. It is a single page, responsive website that is built with HTML, CSS, and JavaScript.",
    ...
    },
    {
      ...
      firstParagraph:
        "This is a productivity app that utilizes the React framework. It is a single page, responsive website that is built with HTML, CSS, and Javascript.  This page also won the Devslopes Hackathon.",
    ...
    },
    {
      ...
      firstParagraph:
        "This is a clone of Nintendo's website. It is a single page that is built with HTML and CSS.",
    ...
    },
    {
      ...
      firstParagraph:
        "This is a clone of Monstercat's website. It is a single page that is built with HTML and CSS.",
      link: "https://monstercat-clone-six.vercel.app/",
    },
    {
      id: "modal7",
      h3: "Coder Landing Page",
      img: "./assets/img/coderlandingpage.png",
      strongParagraph: "Landing Page",
      firstParagraph:
        "This is a landing page that has responsive CSS.  It is a single page that is built with HTML and CSS that is designed to drive conversion rates.",
      link: "https://coder-landing-page.vercel.app",
    },
    {
      id: "modal8",
      h3: "Tetris",
      img: "./assets/img/tetris.png",
      strongParagraph: "Tetris Game",
      firstParagraph: "A Tetris clone done with HTML, CSS, and JavaScript",
      link: "https://tetris-alpha-coral.vercel.app/",
    },
  ],
};
